/*
  # FocusFive Database Schema
  
  This migration ensures tables and policies are created safely with conditional logic
  to prevent errors when objects already exist.
  ...
  2. Security
    ...
    - Conditionally drops and recreates policies to avoid conflicts
*/
